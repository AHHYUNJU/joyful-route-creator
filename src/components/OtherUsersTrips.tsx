...
interface OtherUsersTripsProps {
  selectedLocation?: string;
  selectedDuration?: string;
  selectedInterests?: string[];
}

const OtherUsersTrips = ({ selectedLocation, selectedDuration, selectedInterests }: OtherUsersTripsProps) => {
  ...
  // Filter trips based on selected location and duration
  const getFilteredTrips = () => {
    ...
    if (selectedDuration) {
      filteredTrips = filteredTrips.filter(trip => 
        trip.tripPlan.duration === selectedDuration
      );
    }
